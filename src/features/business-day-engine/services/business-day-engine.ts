...
class BusinessDayEngine {
  ...
  private aggregateMetrics(metricsList: DayMetrics[]): DayMetrics {
    return metricsList.reduce((acc, curr) => ({
      totalRevenue: Number(acc.totalRevenue || 0) + Number(curr.totalRevenue || 0),
      bookingRevenue: Number(acc.bookingRevenue || 0) + Number(curr.bookingRevenue || 0),
      membershipRevenue: Number(acc.membershipRevenue || 0) + Number(curr.membershipRevenue || 0),
      giftCardRevenue: Number(acc.giftCardRevenue || 0) + Number(curr.giftCardRevenue || 0),
      cashSales: Number(acc.cashSales || 0) + Number(curr.cashSales || 0),
      upiSales: Number(acc.upiSales || 0) + Number(curr.upiSales || 0),
      cardSales: Number(acc.cardSales || 0) + Number(curr.cardSales || 0),
      bankSales: Number(acc.bankSales || 0) + Number(curr.bankSales || 0),
      totalExpenses: Number(acc.totalExpenses || 0) + Number(curr.totalExpenses || 0),
      expensesTotal: Number(acc.expensesTotal || 0) + Number(curr.expensesTotal || 0),
      guestCount: Number(acc.guestCount || 0) + Number(curr.guestCount || 0),
      bookingCount: Number(acc.bookingCount || 0) + Number(curr.bookingCount || 0),
      bookingsCount: Number(acc.bookingsCount || 0) + Number(curr.bookingsCount || 0),
      membershipCount: Number(acc.membershipCount || 0) + Number(curr.membershipCount || 0),
      giftCardCount: Number(acc.giftCardCount || 0) + Number(curr.giftCardCount || 0),
      refundCount: Number(acc.refundCount || 0) + Number(curr.refundCount || 0),
      refundTotal: Number(acc.refundTotal || 0) + Number(curr.refundTotal || 0),
      membershipRedemptionsCount: Number(acc.membershipRedemptionsCount || 0) + Number(curr.membershipRedemptionsCount || 0),
      membershipRedemptionsValue: Number(acc.membershipRedemptionsValue || 0) + Number(curr.membershipRedemptionsValue || 0),
      giftCardRedemptionsCount: Number(acc.giftCardRedemptionsCount || 0) + Number(curr.giftCardRedemptionsCount || 0),
      giftCardRedemptionsValue: Number(acc.giftCardRedemptionsValue || 0) + Number(curr.giftCardRedemptionsValue || 0),
      openingCash: Number(acc.openingCash || 0) + Number(curr.openingCash || 0),
      expectedClosingCash: Number(acc.expectedClosingCash || 0) + Number(curr.expectedClosingCash || 0),
      cashInHand: Number(acc.cashInHand || 0) + Number(curr.cashInHand || 0),
      actualCashCounted: Number(acc.actualCashCounted || 0) + Number(curr.actualCashCounted || 0),
      cashDifference: Number(acc.cashDifference || 0) + Number(curr.cashDifference || 0),
